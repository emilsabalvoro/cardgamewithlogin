package com.sample.emil.cardgamewithlogin.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public List<User> getAllUser() {
         ...
         * SELECT user_id,user_username,user_password FROM user ORDER BY user_username;
         */
    ...
    public boolean checkUser(String username) {
         ...
         * Here query function is used to fetch records from user table this function works like we use sql query.
         * SQL query equivalent to this query function is
         * SELECT user_id FROM user WHERE user_username= 'emil';
         */
        Cursor cursor = db.query(TABLE_USER, //Table to query
                columns,                    //columns to return
    ...
    public boolean checkUser(String username, String password) {
         ...
         * Here query function is used to fetch records from user table this function works like we use sql query.
         * SQL query equivalent to this query function is
         * SELECT user_id FROM user WHERE user_username = 'emil' AND user_password = 'emil123';
         */
        Cursor cursor = db.query(TABLE_USER, //Table to query
                columns,                    //columns to return
                selection,                  //columns for the WHERE clause
